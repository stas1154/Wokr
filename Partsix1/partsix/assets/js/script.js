...
const quantityWrapper = document.querySelectorAll(".quantity__box, .quantity__box2");
...
document.addEventListener("DOMContentLoaded", function() {
    var customRadioButton = document.getElementById("weight12");
    var customButtonContainer = document.getElementById("customButtonContainer");

    customRadioButton.addEventListener("change", function() {
        if (customRadioButton.checked) {
            customButtonContainer.innerHTML = '<button id="customButton">Custom Button</button>';
            customButtonContainer.style.display = "block";
        } else {
            customButtonContainer.innerHTML = ''; // Remove the button if Custom option is unchecked
            customButtonContainer.style.display = "none";
        }
    });
});
