...
! function(e, t) {
    ...
    var radioButtons = document.querySelectorAll('.variant__size--list input[type="radio"]');
    var quantityInput = document.querySelector('.quantity__number');

    // Устанавливаем начальное значение в 10
    quantityInput.value = 1;

    radioButtons.forEach(function(radioButton) {
        radioButton.addEventListener("change", function() {
            if (!document.getElementById("weight12").checked) {
                customButtonContainer.style.display = "none";
                quantityInput.value = 1; // Установка значения в 10 при выборе одной из предопределенных опций
            }
        });
    });
    ...
    customRadioButton.addEventListener("change", function() {
        if (customRadioButton.checked) {
            ...
            customButtonContainer.style.display = "none";
            quantityInput.value = 1; // Установка значения в 10 при закрытии блока "Custom"
        }
    });

    // Добавляем обработчик события на кнопку "Custom"
    customButtonContainer.addEventListener("click", function(event) {
        var customButton = document.getElementById("customButton");
        if (customButton && event.target === customButton) {
            // Действие по нажатию на кнопку "Custom"
